...
def get_wds_dataset(args, preprocess_img, is_train, epoch=0, floor=False, tokenizer=None):
    ...
    print(f"Using {'train_data' if is_train else 'val_data'} path: {input_shards}")
    ...
    pipeline.extend([
        ...
        wds.map_dict(image=preprocess_img,
                     text=lambda text: tokenizer(text, errors='ignore')[0]),
    ...
    if is_train:
        if not resampled:
            ...
            print(len(expand_urls(input_shards)[0]))
            print(num_shards)
