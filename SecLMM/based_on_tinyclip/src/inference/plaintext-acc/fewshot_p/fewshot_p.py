...
if task_name == "cifar10":
    subprocess.run(["python", "base_cifar10.py"])
elif task_name == "cifar100":
    subprocess.run(["python", "base_cifar100.py"])
elif task_name == "tiny-imagenet":
    subprocess.run(["python", "base_tiny.py"])
elif task_name == "fairface-age":
    subprocess.run(["python", "base_fairage.py"])
elif task_name == "fairface-gender":
    subprocess.run(["python", "base_fairgender.py"])
elif task_name == "fairface-race":
    subprocess.run(["python", "base_fairrace.py"])