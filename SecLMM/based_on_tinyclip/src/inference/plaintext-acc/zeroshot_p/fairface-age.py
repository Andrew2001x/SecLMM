...
# Create mappings between age group labels and their corresponding IDs
...
prompt = [
    'a photo of people between the ages of 0 and 2',
    'a photo of people between the ages of 3 and 9',
    'a photo of people between the ages of 10 and 19',
    'a photo of people between the ages of 20 and 29',
    'a photo of people between the ages of 30 and 39',
    'a photo of people between the ages of 40 and 49',
    'a photo of people between the ages of 50 and 59',
    'a photo of people between the ages of 60 and 69',
    'a photo of people aged 70 or older'
]
...
# Define a function to predict age group labels for a batch of images
def get_image_predict_label(images):
    ...
    # Get predicted label IDs by selecting the age group with the highest probability
    label_ids = jnp.argmax(probs, axis=1).tolist()
    # Map label IDs to age group labels
...
while start < len(cifar_10_test):
    # Extract a batch of images and their corresponding age group labels
    sample = cifar_10_test[start:end]
    img_list, label_id_list = sample['image'], sample['age']
    # Map true label IDs to age group labels and store them
    y_true.extend([id_label_dict[label_id] for label_id in label_id_list])
    # Predict age group labels for the batch of images
