...
def get_token_ids1():
    with open('prompt_mask/prompt_fairface_age.txt', 'r') as file:
        content = file.read()
...
def get_token_ids2():
    with open('prompt_mask/mask_fairface_age.txt', 'r') as file:
        content = file.read()
...
np.savetxt("outputs_text_fairage.txt", outputs_ids, fmt="%.8f")