...
if task_name == "cifar10":
    subprocess.run(["python", "cipher_cifar10_image_feature.py"])
    subprocess.run(["python", "cipher_cifar10_text_feature.py"])
    subprocess.run(["python", "predict_plain_client_cifar10.py"])
elif task_name == "cifar100":
    subprocess.run(["python", "cipher_cifar100_image_feature.py"])
    subprocess.run(["python", "cipher_cifar100_text_feature.py"])
    subprocess.run(["python", "predict_plain_client_cifar100.py"])
elif task_name == "tiny-imagenet":
    subprocess.run(["python", "cipher_tinyimage_image_feature.py"])
    subprocess.run(["python", "cipher_tinyimage_text_feature.py"])
    subprocess.run(["python", "predict_plain_client_tiny.py"])
elif task_name == "fairface-age":
    subprocess.run(["python", "cipher_fairage_image_feature.py"])
    subprocess.run(["python", "cipher_fairage_text_feature.py"])
    subprocess.run(["python", "predict_plain_client_fairage.py"])
elif task_name == "fairface-gender":
    subprocess.run(["python", "cipher_fairgender_image_feature.py"])
    subprocess.run(["python", "cipher_fairgender_image_feature.py"])
    subprocess.run(["python", "predict_plain_client_fairgender.py"])
elif task_name == "fairface-race":
    subprocess.run(["python", "cipher_fairrace_image_feature.py"])
    subprocess.run(["python", "cipher_fairrace_image_feature.py"])
    subprocess.run(["python", "predict_plain_client_fairrace.py"])