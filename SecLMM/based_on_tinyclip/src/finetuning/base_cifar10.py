...
def f_train(cifar_10, sh=5):
    ...
    sample_labels = [sample['label'] for sample in f_samples]
...
def f_eval(clf, scaler, cifar_10_test, batch_size=200):
    ...
    test_labels = jnp.array([sample['label'] for sample in cifar_10_test])  # 使用 JAX 数组
...
model_filename = "f_clf_model_base_cifar10.pkl"
joblib.dump(clf, model_filename)
scaler_filename = "f_scaler_base_cifar10.pkl"
...
print(classification_report(cifar_10['test']['label'], pred_labels, target_names=labels, digits=4))
